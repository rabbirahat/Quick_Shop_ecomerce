    ...
    <div>
      ...
      <div className=" overflow-x-auto rounded-md">
        <table className="w-full text-sm text-left">
          ...
          <tbody>
            <tr>
              <td className="px-6 py-4">web-111qast</td>

              <td className="px-6 py-4">11 december, 2022</td>

              <td className="px-6 py-4">Processing</td>
              <td className="px-6 py-4">$125</td>
              <td className="px-6 py-4 text-success">View</td>
            </tr>
            <tr>
              <td className="px-6 py-4">web-111qast</td>
              ...
              <td className="px-6 py-4 text-scale1">Completed</td>
              <td className="px-6 py-4">$125</td>
              <td className="px-6 py-4 text-success">View</td>
            </tr>
            <tr>
